...
let swiperarticles = new Swiper(".articles__container", {
    loop: false, /* (obs) para rodar o Publications com mas de 3 é necessario deixar true */
    grapCursor: false, /* (obs) para rodar o Publications com mas de 3 é necessario deixar true */
    spaceBetween: 40,
